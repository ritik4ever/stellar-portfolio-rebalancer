...
const spec: Record<string, any> = {
  ...
  info: {
    ...
    description:
      "Intelligent portfolio rebalancing service for the Stellar ecosystem using Reflector oracles. Create portfolios, fetch prices, execute rebalances, and manage risk.",
    version: "1.0.0",
    contact: {
      name: "API Support",
  ...
  paths: {
    ...
    "/ready": {
      get: {
        ...
        description:
          "Deep readiness probe covering database, Redis/queues, workers, indexer, and auto-rebalancer startup.",
        responses: {
          "200": {
    ...
    "/api/rebalance/history": {
      get: {
        ...
        description:
          "List rebalance events, optionally filtered by portfolio and source.",
        parameters: [
          {
            name: "portfolioId",
            in: "query",
          ...
          },
          {
            ...
            schema: {
              type: "string",
              enum: ["offchain", "simulated", "onchain"],
            },
          },
          {
            name: "startTimestamp",
    ...
    "/api/rebalance/history/sync-onchain": {
      post: {
        ...
        description:
          "Trigger a one-time sync of on-chain rebalance events. Admin only.",
        security: [{ adminAuth: [] }],
        responses: {
          "200": {
    ...
    "/api/portfolio": {
      post: {
        ...
        description:
          "Create a new portfolio with target allocations and threshold. Allocations must sum to 100%.",
        requestBody: {
          required: true,
          content: {
            "application/json": {
              schema: {
                ...
                properties: {
                  ...
                  allocations: {
                    ...
                    description:
                      'Target weights per asset (e.g. { "XLM": 40, "BTC": 30, "USDC": 30 }), must sum to 100',
                  },
                  threshold: {
                    type: "number",
                    minimum: 1,
    ...
    "/api/user/{address}/portfolios": {
      get: {
        ...
        description:
          "Get all portfolios for a Stellar address. When JWT auth is enabled, only the authenticated user (token subject) may list portfolios for their own address. In demo mode, public-by-address listing is allowed only when ALLOW_PUBLIC_USER_PORTFOLIOS_IN_DEMO is enabled.",
        parameters: [
          {
            name: "address",
            in: "path",
    ...
    "/api/portfolio/{id}/rebalance-plan": {
      get: {
        ...
        description:
          "Get total value, slippage, and current prices for planning.",
        parameters: [
          {
            name: "id",
            in: "path",
    ...
    "/api/portfolio/{id}/rebalance": {
      post: {
        ...
        description:
          "Run rebalance for a portfolio. May return 409 if rebalance already in progress.",
        parameters: [
          {
            name: "id",
            in: "path",
    ...
    "/api/portfolio/{id}/attribution": {
      get: {
        tags: ["Portfolio"],
        summary: "Get portfolio performance attribution",
        description:
          "Returns per-asset contribution to total portfolio return over a time period. Attribution = weight * asset return for each asset.",
        parameters: [
          {
            name: "id",
            in: "path",
          ...
          },
          {
            ...
            in: "query",
            schema: { type: "string", format: "date-time" },
            description: "Optional ISO timestamp to start the range.",
          },
          {
            name: "to",
            in: "query",
            schema: { type: "string", format: "date-time" },
            description: "Optional ISO timestamp to end the range.",
          },
        ],
        responses: {
          "200": {
    ...
    "/api/prices": {
      get: {
        ...
        description:
          "Current asset prices (XLM, BTC, ETH, USDC, etc.) from Reflector/CoinGecko.",
        responses: {
          "200": {
    ...
    "/api/auto-rebalancer/status": {
      get: {
        ...
        description:
          "Current status and statistics of the automatic rebalancing service.",
        responses: {
          "200": {
                  ...
                  properties: {
                    ...
                    data: {
                      ...
                      properties: {
                        status: {
                          type: "object",
                          properties: { isRunning: { type: "boolean" } },
                        },
    ...
    "/api/auto-rebalancer/force-check": {
      post: {
        ...
        summary: "Force check",
        description:
          "Trigger an immediate check of all portfolios. Admin only.",
        security: [{ adminAuth: [] }],
        responses: {
          "200": {
    ...
    "/api/system/status": {
      get: {
        ...
        description:
          "Comprehensive system status: portfolios, rebalance history, risk, auto-rebalancer, indexer, feature flags.",
        responses: {
          "200": {
                    ...
                    data: {
                      ...
                      properties: {
                        ...
                        workers: {
                          type: "object",
                          description:
                            "Per-worker runtime status including lifecycle state, last-run timestamps, and scheduler registration",
                          properties: {
                            portfolioCheck: { type: "object" },
                            rebalance: { type: "object" },
                            analyticsSnapshot: { type: "object" },
  ...
  components: {
    ...
    schemas: {
      ...
      AttributionContribution: {
        ...
        properties: {
          asset: { type: "string" },
          startWeightPercent: { type: "number" },
          endWeightPercent: { type: "number" },
          startValue: { type: "number" },
          endValue: { type: "number" },
          assetReturnPercent: { type: "number" },
      ...
      AttributionResult: {
        ...
        properties: {
          ...
          contributions: {
            type: "array",
            items: { $ref: "#/components/schemas/AttributionContribution" },
          },
        },
      },
      ...
      NotificationPreferencesInput: {
        ...
        properties: {
          userId: {
            type: "string",
            description:
              "Omitted when JWT auth is enabled (derived from token).",
          },
          ...
          webhookUrl: {
            ...
            pattern: "^https?://",
            description:
              "Required when webhookEnabled is true. Must use http or https.",
          },
