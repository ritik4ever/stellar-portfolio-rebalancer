...
For issue management, see the [Backlog Grooming Guide](docs/backlog-grooming.md). For wallet-specific connection, signing, or network failures, use the [wallet bug report template](.github/ISSUE_TEMPLATE/wallet-bug-report.md).
