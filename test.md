...
#578 Add curl recipe examples folder for common API tasks
Repo Avatar ritik4ever/stellar-portfolio-rebalancer

Practical examples help contributors and integrators validate behavior more quickly than prose alone.

Category: docs
Project area: docs, API.md, backend/src/api

Implementation:

    Review the current documentation or contributor flow in docs, API.md, backend/src/api.
    Create a set of copy-paste curl recipes that cover the most common API workflows in this repository.
